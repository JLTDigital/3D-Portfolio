  ...
  return (
    <group {...props} dispose={null}>
      <group
        ...
        userData={{ name: 'Screen C.001_102' }}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group
        ...
        rotation={[0, 1.002, 0]}
        userData={{ name: 'Screen B.001_103' }}>
        <mesh
          castShadow
          receiveShadow
        ...
        <mesh
          ...
          material={materials.Screen}
          userData={{ name: 'Object_210' }}
        />
      </group>
      <group
        position={[-2.731, 0.629, -0.522]}
        rotation={[0, 1.087, 0]}
        userData={{ name: 'Screen A.001_104' }}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group
        ...
        userData={{ name: 'Screen D.001_105' }}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group
        ...
        rotation={[0, -0.793, 0]}
        scale={0.81}
        userData={{ name: 'Screen C.002_106' }}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group
        ...
        rotation={[0, 1.222, 0]}
        scale={0.9}
        userData={{ name: 'Screen B.002_107' }}>
        <mesh
          castShadow
          receiveShadow
        ...
        <mesh
          ...
          material={materials.Screen}
          userData={{ name: 'Object_222' }}
        />
      </group>
      <group
        position={[-3.899, 4.287, -2.642]}
        rotation={[0, 0.539, 0]}
        userData={{ name: 'Screen D.002_108' }}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group
        ...
        rotation={[0, 0.429, 0]}
        scale={[-1, 1, 1]}
        userData={{ name: 'Screen D.003_109' }}>
        <mesh
          castShadow
          receiveShadow
        ...
        <mesh
          ...
          material={materials.Screen}
          userData={{ name: 'Object_228' }}
        />
      </group>
      <group
        position={[4.683, 4.29, -1.558]}
        rotation={[0, -Math.PI / 3, 0]}
        userData={{ name: 'Screen D.004_110' }}>
        <mesh
          castShadow
          receiveShadow
